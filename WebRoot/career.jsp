...
<jsp:directive.page import="com.callcenter.dao.DBUtilDaoImp"/><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><img src="images/header.jpg" width="999" height="198" /></div></td>
          </tr>
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="99%" valign="top" background="images/header1_06.png" scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <td width="9%"><a href="index.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','images/header_05_01_01.png',1)"><img src="images/header1_05_01.png" name="Image8" width="86" height="54" border="0" id="Image8" /></a></td>
                    ...
                    <td width="8%"><a href="faq.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','images/header_05_01_06.png',1)"><img src="images/header1_05_061.png" name="Image13" width="77" height="54" border="0" id="Image13" /></a></td>
                    ...
                    <td width="2%"><a href="career.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','images/header_05_01_08.png',1)"><img src="images/header1_05_08.png" name="Image17" width="101" height="54" border="0" id="Image17" /></a></td>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#0099CC">
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr>
                        <td   align="center"><font color="red"> <h2>Vacency</h2></font></td></tr>
                      <tr>
              <tr>
                <td><table width="98%" border="0" align="center" cellpadding="5" cellspacing="0">
                     ...
                     <tbody>
                        ...
                        <th height="" class="bodytext" ><font color="red"> <h4>Name of post</h4></font></th>
                        <th height="" class="bodytext"><font color="red"> <h4>Requirment</h4></font></th>
                        <th height="" class="bodytext" ><font color="red"> <h4>Skill</h4></font></th>
                        <th height="" class="bodytext"><font color="red"> <h4>Salary</h4></font></th>
                        <th height="" class="bodytext"><font color="red"> <h4>Experience</h4></font></th>
                        </td>
                      </tr><%
                      ...
                      while(rs.next())
                      {
                      String vacancyname=rs.getString("vacancyname");
                      String discreption=rs.getString("discreption");
                     
                      String keyskill=rs.getString("keyskill");
                       String designation=rs.getString("designation");
                       String salaryrange=rs.getString("salaryrange");
                       String exper=rs.getString("exper");
                       ...
                       <tr>
                        ...
                        <th height="" class="bodytext"><div align="left"><h5><%=vacancyname %></h5></div></th>
                        <th height="" class="bodytext"><div align="left"><h5><%=discreption %> </h5></div></th>
                         <th height="" class="bodytext"><div align="left"><h5><%=keyskill %></h5></div></th>
                        <th height="" class="bodytext"><div align="left"><h5><%=salaryrange %> </h5></div></th>
                        <th height="" class="bodytext"><div align="left"><h5><%=exper %> </h5></div></th>
                        </td>
                    ...
                    <td class="bodytext"><a href="applyonline.html" > <font color="red"> <h4>apply online</h4></font>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
      ...
      <tr>
        <td height="25" align="center" class="bodytext"><div align="center"><a href="index.html" class="bodytext">Home</a> | <a href="call-center-management.html" class="bodytext">About Us</a> | <a href="services.html" class="bodytext">Services</a>  | <a href="help.html" class="bodytext">Help</a> | <a href="faq.html" class="bodytext">FAQ</a> | <a href="contact-us.html" class="bodytext">Contact Us</a> | <a href="feedback.php" class="bodytext">Feedback</a> | <a href="sitemap.html" class="bodytext">Sitemap</a> </div></td>
      </tr>
      <tr>
        <td height="25" align="center" bgcolor="#0099CC" class="copyright">@Synechron Private Limited. All Rights Reserved</td>
      </tr>
    </table></td>
  </tr>
</table>
