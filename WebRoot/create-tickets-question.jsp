...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="84%"><span class="subheadings">Create Customer Ticket : </span></td>
            ...
            <tr>
              <td width="94%" height="200"><div align="center">
                  <table width="95%" border="0" align="center" cellpadding="5" cellspacing="1">
                    <tbody>
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">service Type:</font></span></div></td>
                      ...
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">Category Type:</font></span></div></td>
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                      ...
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">Descretion:</font></span></div></td>
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                           
                            <textarea name="descreption" cols="24" rows="3" ></textarea>
                        </font></span></div></td>
                        
                      </tr>
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">
                       <input type="hidden" name="userId" value="<%=request.getParameter("userId") %>">   
                      </tr>
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">Priority:</font></span></div></td>
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
