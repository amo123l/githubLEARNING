  ...
  <tr>
    <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="84%"><span class="subheadings">Cutomer Information : </span></td>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                            <%=request.getAttribute("descrption") %>
                        </font></span></div></td>
                        
                      </tr>
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">Date:</font></span></div></td>
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                            <%=request.getAttribute("date") %>                        </font></span></div></td>
                       ...
                       <tr>
                        ...
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                            <%=request.getAttribute("status") %>                        </font></span></div></td>
                      ...
                      <tr>
                        ...
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                            <%=request.getAttribute("category") %>                        </font></span></div></td>
