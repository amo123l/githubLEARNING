...
<form action="custticket" name="fn" target="customer">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="84%"><span class="subheadings"> Ticket Information : </span></td>
            ...
            <tr>
              <td width="94%" height="200"><div align="center">
                  <table width="95%" border="0" align="center" cellpadding="5" cellspacing="1">
                    <tbody>
                      <tr>
                        <td height="23" class="bodytext"><div align="left"><span class="style10"><font color="#000000" sans-serif="sans-serif" helvetica,="helvetica," arial,="arial,">Ticket No:</font></span></div></td>
                        <td height="23" class="bodytext"><div align="left"><span class="style5"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
                            <input maxlength="100" 
            name="ticketno" size="30" />
                        </font></span></div></td>
